# menu-publisher - miscellaneous 3
...
erDiagram
    ...
    store_menu_special_availability {
        ...
        boolean is_hidden
        boolean active
        boolean deactivate_by_exception
        string row_hash
    ...
    common_menu_display_group ||--o{ store_menu_special_availability : display_group_id
    ...
    common_menu_upsell_category ||--o{ store_menu_special : upsell_category_id
