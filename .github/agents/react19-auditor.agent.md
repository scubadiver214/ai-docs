...
pnpm ls --depth=0 2>&1 | grep -E "WARN|ERR|peer|invalid|unmet" | head -30
```
...
grep -rn "ReactDOM\.render\s*(" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 2. ReactDOM.hydrate  REMOVED
grep -rn "ReactDOM\.hydrate\s*(" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 3. unmountComponentAtNode  REMOVED
grep -rn "unmountComponentAtNode" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 4. findDOMNode  REMOVED
grep -rn "findDOMNode" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 5. createFactory  REMOVED
grep -rn "createFactory\|React\.createFactory" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 6. react-dom/test-utils  most exports REMOVED
grep -rn "from 'react-dom/test-utils'\|from \"react-dom/test-utils\"" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 7. Legacy Context API  REMOVED
grep -rn "contextTypes\|childContextTypes\|getChildContext" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null

# 8. String refs  REMOVED
grep -rn "this\.refs\." src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" 2>/dev/null
```
...
grep -rn "forwardRef\|React\.forwardRef" src/ --include="*.js" --include="*.jsx" --include="*.ts" --include="*.tsx" | grep -v "\.test\." 2>/dev/null
```
...
grep -rn "\.defaultProps\s*=" src/ --include="*.js" --include="_.jsx" --include="_.ts" --include="\*.tsx" 2>/dev/null

# 11. useRef() without initial value

grep -rn "useRef()\|useRef( )" src/ --include="_.js" --include="_.jsx" --include="_.ts" --include="_.tsx" 2>/dev/null

# 12. propTypes (runtime validation silently dropped in React 19)

grep -rn "\.propTypes\s*=" src/ --include="*.js" --include="_.jsx" --include="_.ts" --include="\*.tsx" | grep -v "\.test\." | wc -l

# 13. Unnecessary React default imports

grep -rn "^import React from 'react'" src/ --include="_.js" --include="_.jsx" --include="_.ts" --include="_.tsx" | grep -v "\.test\." 2>/dev/null
