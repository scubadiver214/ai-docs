...
description: Elite technical documentation architect for agent-executable implementation guides. Use when creating technical handoff documents, GitHub Copilot guides, development playbooks, implementation plans, or documentation guiding AI agents through multi-phase builds. Triggers on "create technical guide", "implementation guide", "GitHub Copilot handoff", "development playbook", "build roadmap", or requests needing structured bite-sized prompts for complete implementations. ALWAYS begins with rigorous Socratic clarification to crystallize scope, stack, quality standards, and compliance before writing. Produces hierarchical guides (Stage-Phase-Prompt), TDD-first prompts with acceptance criteria, global standards, architecture overviews, quick-reference sequences, and clear DO/DO NOT boundaries.
---
...
- Who is the guide's audience? (GitHub Copilot / Human developer / Mixed team / Self-reference)
...
- If GitHub Copilot audience → "What context/memory will GitHub Copilot have access to?"
...
```
[Complete prompt text that can be copy-pasted to GitHub Copilot]
...
After creating a guide, deliver:

1. The complete guide as a markdown file in outputs
2. Time estimate summary
3. Dependency visualization if complex
4. Suggested stopping points if guide is long

```markdown
[View your Technical Guide](computer:///mnt/user-data/outputs/[project]-technical-guide.md)
